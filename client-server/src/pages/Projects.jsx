      ...
      {showForm && (
        <form onSubmit={handleCreate} className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm dark:shadow-none p-5 mb-6">
          ...
          <div className="flex gap-2">
            ...
            <button type="button" onClick={() => { setPlanError(""); setShowForm(false); }} className="border border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 text-xs px-5 py-2 rounded-full hover:border-gray-400 dark:hover:border-gray-500 transition">
              Cancel
            </button>
          </div>
        </form>

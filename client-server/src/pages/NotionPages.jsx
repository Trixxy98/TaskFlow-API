    ...
    <div className="flex flex-1 min-h-screen">
      ...
      <div className="w-56 bg-gray-50 dark:bg-gray-950 border-r border-gray-100 dark:border-gray-800 flex flex-col flex-shrink-0">
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-gray-800">
          ...
          <button onClick={createPage} className="w-5 h-5 flex items-center justify-center rounded text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-800 transition" aria-label="New page">
        ...
        <div className="p-3 border-t border-gray-100 dark:border-gray-800">
          <button onClick={createPage} className="w-full flex items-center gap-2 px-3 py-2 text-xs text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-white dark:hover:bg-gray-900 rounded-lg transition">
            <Plus className="w-3.5 h-3.5" /><span>New Page</span>
          </button>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto">
        {!currentPage ? (
          <div className="flex flex-col items-center justify-center h-full text-center p-8">
            ...
            <button onClick={createPage} className="inline-flex items-center gap-1.5 bg-gray-900 dark:bg-blue-600 text-white text-sm px-5 py-2 rounded-xl hover:bg-gray-700 dark:hover:bg-blue-500 transition">

  ...
  return (
    <div className="flex-1 p-4 md:p-8 max-w-2xl mx-auto w-full">
      <div className="mb-8">
        ...
        <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">Nota dan komen untuk tasks</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-gray-400 dark:text-gray-500 text-sm">Belum ada feedback</p>
        </div>
      ) : (

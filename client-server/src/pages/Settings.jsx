  ...
  return (
    <div className="flex-1 p-4 md:p-8 max-w-2xl mx-auto w-full">
      <div className="mb-8">
        ...
        <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">Urus akaun dan keutamaan anda</p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm dark:shadow-none p-5 mb-4">
        <h3 className="text-sm font-semibold text-gray-800 dark:text-gray-100 mb-4">Profil</h3>
        <form onSubmit={handleSave} className="space-y-3">
          <div>
            <label className="text-xs text-gray-400 dark:text-gray-500 block mb-1">Nama</label>
            <input
              type="text"
              value={name}
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm dark:shadow-none p-5">
        <h3 className="text-sm font-semibold text-gray-800 dark:text-gray-100 mb-4">Notifikasi</h3>
